...
!!! tip
    ...
    If you're not, work through the [Vulcan Quickstart](configurations/guides/get-started/docker.md) before continuing!
...
!!! warning "External catalogs"
    ...
    You can however still reference a table from an external catalog in your model as a normal [external table](configurations/components/model/types/external_models.md).
