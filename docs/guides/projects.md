...
Before getting started, ensure that you meet the [prerequisites](../prerequisites.md) for using Vulcan.
...
If using CLI or Notebook, you can open a file in your project for editing by using the `vulcan` command with the `-p` variable, and pointing to your project's path as follows:
